...
SOUNDINFO g_aSoundInfo[SOUND_LABEL_MAX] =
{
	...
	{"data/SOUND/BGM/BGM_GAME.wav", -1, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},		// ゲーム画面のBGM
	{"data/SOUND/BGM/BGM_BADEND.wav", -1, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},		// バッドエンド画面のBGM
	{"data/SOUND/BGM/BGM_NORMALEND.wav", -1, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},		// ノーマルエンド画面のBGM
	{"data/SOUND/BGM/BGM_SUPERHAPPYEND.wav", -1, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},		// スーパーハッピーエンド画面のBGM
	...
	{"data/SOUND/SE/SE_MOVE.wav", 0, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},			// プレイヤー移動音
	{"data/SOUND/SE/SE_MOVEDASH.wav", 0, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},		// プレイヤー移動音(ダッシュ)
	{"data/SOUND/SE/SE_MOUSEMOVE.wav", 0, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},		// ネズミ移動音
	{"data/SOUND/SE/SE_JUMP.wav", 0, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},			// 跳躍音
	{"data/SOUND/SE/SE_MOUSEJUMP.wav", 0, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},		// ネズミ跳躍音
	{"data/SOUND/SE/SE_LAND.wav", 0, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},			// 着地音
	{"data/SOUND/SE/SE_MOUSELAND.wav", 0, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},		// ネズミ着地音
	{"data/SOUND/SE/SE_THROW.wav", 0, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},			// 投擲音
	{"data/SOUND/SE/SE_CATAPALT.wav", 0, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},		// 射出方向変更時の音
	{"data/SOUND/SE/SE_ARMSWITCH.wav", 0, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, D3DXVECTOR3_NULL, false},		// アームの切り替え音
...
HRESULT InitSound(HWND hWnd)
{
	...
	for(int nCntSound = 0; nCntSound < SOUND_LABEL_MAX; nCntSound++)
	{
		...
		// バッファの値設定
		memset(&buffer, 0, sizeof(XAUDIO2_BUFFER));
		memset(&g_aSourceVoiceDetails[nCntSound], 0, sizeof(XAUDIO2_VOICE_DETAILS));
