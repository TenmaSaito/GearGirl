...
//*** マクロ定義 ***
//**********************************************************************************
#define USE_PARAM		using namespace Constants		// Constants使用宣言
...
namespace Constants 
{
	...
	STRUCT(CParamVector)
	{
		static const D3DXVECTOR4 V4NULL;	// Vector4 Null
		static const D3DXVECTOR3 V3NULL;	// Vector3 Null
		static const D3DXVECTOR3 V3ONE;		// Vector3 1
		static const D3DXVECTOR3 WINMID;	// Vector3 WinMid
		static const D3DXVECTOR2 V2NULL;	// Vector2 Null
	} CParamVector;
